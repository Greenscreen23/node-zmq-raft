...
declare namespace node_zmq_raft {
  ...
  namespace client {
    ...
    class ZmqRaftPeerClient extends ZmqProtocolSocket {
      constructor(urls?: string | Array<string>, options: Object);
    ...
    class ZmqRaftClient extends ZmqRaftPeerClient {
      ...
      requestLogInfo(anyPeer: boolean, rpctimeout?: number): Promise;
      configUpdate(
        id: string | Buffer,
        peers: Array,
        rpctimeout: number
    ...
    class ZmqRaftPeerSub extends ZmqRaftPeerClient {
      constructor(urls?: string | Array<string>, options: Partial<{
        url: string,
        urls: Array<string>,
        secret: string | Buffer,
        timeout: number,
      ...
      foreverEntriesStream(lastIndex: number, options: Object): ForeverEntriesStream
    }
    class ForeverEntriesStream extends Readable {
      constructor(client, lastIndex, options);
    }
    class ZmqRaftSubscriber extends Duplex {
      constructor(urls?: string | Array, options?: Partial<{
        url: string,
        urls: Array,
        peers: Array,
        secret: string | Buffer
  ...
  namespace server {
    ...
    class FileLog extends common.ReadyEmitter {
      constructor(logdir: string, snapshot: string, options?: Object | boolean);
      close(): Promise;
      ...
      installSnapshot(snapshot: SnapshotFile, compactOnly?: boolean): Promise;
