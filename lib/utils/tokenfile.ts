...
export const BYTES_PER_ELEMENT = Uint32Array.BYTES_PER_ELEMENT;

export const TOKEN_HEADER_SIZE = 2;
export const TOKEN_HEADER_BYTE_SIZE = TOKEN_HEADER_SIZE * BYTES_PER_ELEMENT;
 ...
 * @return {Uint32}
**/
export function tokenToUint32(token) {
 ...
 * @return {Promise}
**/
export function findToken(fd, token, position, stop) {
 ...
 * @return {Promise}
**/
export function createTokenFile(filename) {
