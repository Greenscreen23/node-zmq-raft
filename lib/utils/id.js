...
**/
export const genIdent = function(encoding, offset) {
  var time = (now()/1000)>>>0;
 ...
 * @return {bool}
**/
export const isIdent = function(value) {
 ...
 * @return {number}
**/
export const getSeconds = function(value, offset) {
  if ('string' === typeof value) {
    ...
    timeBuf.write(value, 0, 4, encoding);
    value = timeBuf;
    offset = 0;
  }
  else offset >>>= 0;
