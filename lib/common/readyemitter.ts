...
Implementations should call this[Symbol.for('setReady')]() whenever the asynchronous initialisation completes successfully.
...
export default exports = ReadyEmitter;
