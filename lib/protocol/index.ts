...
export const FramesProtocol = FramesProtocol;

export const createFramesProtocol = function(name, options) {
...
export const InstallSnapshotRPC = [
  /* request */
  [
    'buffer', // type
    'buffer', // secret
...
export const RequestEntriesRPC = [
  /* request */
  [
    'buffer', // type
    'buffer', // secret
...
export const RequestLogInfoRPC = [
  /* request */
  [
    'buffer', // type
    'buffer'  // secret
...
export const StateBroadcastRPC = [
  /* request */
  [
    'buffer', // secret
    'uint',   // leader's term
